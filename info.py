...
API_ID = int(environ.get('API_ID', '24543641'))
API_HASH = environ.get('API_HASH', 'b4aa1a6d4374332810076cdf53f08e96')
BOT_TOKEN = environ.get('BOT_TOKEN', "b4aa1a6d4374332810076cdf53f08e96")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6245830027').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002009290379').split()]
...
DATABASE_NAME = environ.get('DATABASE_NAME', "mikey_kun_781")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002033935696'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'New_Animes_Dubbed_Hindi')
...
URL = "https://mikey-kun-781-bot.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://mikey-kun-781-bot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://mikey-kun-781-bot.onrender.com/".format(FQDN)
else:
    URL = "https://mikey-kun-781-bot.onrender.com/".format(FQDN)
